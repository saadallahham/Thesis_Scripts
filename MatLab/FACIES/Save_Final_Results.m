...
ANSWER_w_x = [DEPTH_w_x, FACIES_W_x, yfit__x_linear_regression, yfit__x_Interactions_linear, yfit__x_Robust_linear, yfit__x_Stepwise_linear,...
...
header = {'DEPTH', 'FACIES', 'LinearRegression', 'InteractionsLinear', 'RobustLinear', 'StepwiseLinear', 'FineTree', 'MediumTree',...
