...
for i = 1:L_W01
    ...
    Train_W01(i,6) = POROSITY_W01(i,1);
    Target_W01(i,1) = POROSITY_W01(i,1); 
end;
...
trainingData.Properties.VariableNames = {'GAMMARAY', 'DENSITY', 'SONICO', 'NEUTRON', 'RESISTIVITY_log', 'POROSITY'};
